...
;; ;;PUT /users/guid
;; (defn login-user [guid request-params]
;;   (print-vals "Login USER : " guid request-params)
...
;;   (if-let [user (find-user request-params)]
;;     (do
;;       (logger/debug "User already in system")
;;       (update-user-creds user request-params))
;;     (do
...
;;   (update-user-creds (user/current-user) request-params))
